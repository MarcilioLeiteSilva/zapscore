...
abstract class AppColor {
  // --- Tema Padrão (Fundo Campeonato Baiano #1D965C e Cards em tom mais escuro #135B37) ---
  ...
  static const Color lightPrimary = Color(0xFF1D965C);     // Verde Campeonato Baiano Destaque
