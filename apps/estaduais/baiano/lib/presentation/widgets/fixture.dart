...
class _HomeTopScorersCardState extends State<HomeTopScorersCard> {
  ...
  int _selectedLeagueId = AppConfig.baianoSerieAId;
  final Map<int, List<Scorer>> _scorersCache = {};
  final Map<int, bool> _loadingMap = {};

  final List<Map<String, dynamic>> _leagues = [
    {'id': AppConfig.baianoSerieAId, 'name': 'Série A'},
    {'id': AppConfig.baianoSerieBId, 'name': 'Série B'},
  ];

  @override
  void initState() {
    super.initState();
    _fetchScorers(AppConfig.baianoSerieAId);
  }
