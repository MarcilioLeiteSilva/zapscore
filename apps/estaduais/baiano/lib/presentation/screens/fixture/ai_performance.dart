  ...
  Future<void> _loadLeagues() async {
    try {
      ...
      final filtered = list.where((league) {
        ...
        return AppConfig.supportedLeagueIds.contains(extId) || name.contains('baiano');
      }).toList();

      bool hasBaiano = filtered.any((l) => AppConfig.supportedLeagueIds.contains(l.externalId) || l.name.toLowerCase().contains('baiano'));

      if (!hasBaiano) {
        filtered.insert(0, League(id: '602', externalId: 602, name: 'Baiano Série A', country: 'Brazil'));
        filtered.add(League(id: '613', externalId: 613, name: 'Baiano Série B', country: 'Brazil'));
      }
      ...
      setState(() {
        _leagues = [
          League(id: '602', externalId: 602, name: 'Baiano Série A', country: 'Brazil'),
          League(id: '613', externalId: 613, name: 'Baiano Série B', country: 'Brazil'),
        ];
      });
    }
  }
