    ...
    return BlocBuilder<FavoriteCubit, FavoriteState>(
      builder: (context, state) {
        final bool isFav = team != null
            ...
            : (league != null
                ? context.read<FavoriteCubit>().isLeagueFavorite(league!.externalId.toString())
                : false);

        final textColor = isFav ? Colors.white : const Color(0xFF1F2937);
        final subtitleColor = isFav ? Colors.white70 : const Color(0xFF1F2937).withOpacity(0.7);
                  ...
                  LikeButton(
                    ...
                    likeBuilder: (bool isLiked) {
                      return Icon(
                        ...
                        color: isLiked ? const Color(0xFFAA7A13) : Colors.black,
                        size: 25,
                      );
                    },
                  ),
