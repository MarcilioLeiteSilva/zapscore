...
class _HomeTopScorersCardState extends State<HomeTopScorersCard> {
  ...
  int _selectedLeagueId = AppConfig.cearenseSerieAId;
  final Map<int, List<Scorer>> _scorersCache = {};
  final Map<int, bool> _loadingMap = {};

  final List<Map<String, dynamic>> _leagues = [
    {'id': AppConfig.cearenseSerieAId, 'name': 'Série A'},
    {'id': AppConfig.cearenseSerieBId, 'name': 'Série B'},
  ];

  @override
  void initState() {
    super.initState();
    _fetchScorers(AppConfig.cearenseSerieAId);
  }
