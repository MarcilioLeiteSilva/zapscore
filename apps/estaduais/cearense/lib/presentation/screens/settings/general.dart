        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () async {
              try {
                await Share.share(
                  'Acompanhe todos os jogos, gols e notícias do Campeonato Cearense em tempo real no ZapScore!\nhttps://play.google.com/store/apps/details?id=com.zapscore.estadualcearense',
                );
              } catch (e) {
                final Uri url = Uri.parse('https://play.google.com/store/apps/details?id=com.zapscore.estadualcearense');
