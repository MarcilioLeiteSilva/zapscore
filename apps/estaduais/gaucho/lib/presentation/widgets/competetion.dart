    ...
    return BlocBuilder<LeagueCubit, LeagueState>(
      builder: (context, state) {
        ...
        if (state is LeagueLoaded) {
          ...
          // 1. Fase de Grupos (Gauchão Série A: Grupo A e Grupo B)
            ...
            return ListView(
              ...
              children: [
                ...
                StandingsTableWidget(
                  ...
                  relegationCount: 0,
                  qualificationDescription: '1º ao 4º colocados avançam para as Quartas de Final. 5º e 6º são eliminados.',
                ),
              ],
            );
          }
          ...
          // 3. 1ª Fase (Grupo Único de 16 clubes na Série A2)
            ...
            return ListView(
              ...
              children: [
                StandingsTableWidget(
                  ...
                  relegationCount: 2,
                  qualificationDescription: '1º ao 8º colocados avançam para as Quartas de Final. 9º ao 14º permanecem na Série A2.',
                  relegationDescription: '15º e 16º colocados são rebaixados para a Segunda Divisão de 2027.',
                ),
              ],
            );
          }
