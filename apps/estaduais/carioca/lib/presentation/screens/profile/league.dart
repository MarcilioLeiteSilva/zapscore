                    ...
                    children: [
                      Expanded(
                        child: _DivisionButton(
                          title: 'Série A1',
                          isSelected: currentLeagueId == 624 || currentLeagueId != 851,
                          onTap: () {
                            if (currentLeagueId != 624) {
                              cubit.switchDivision(624);
                            }
                          },
                        ),
                      ),
                      ...
                      Expanded(
                        child: _DivisionButton(
                          title: 'Série A2',
                          isSelected: currentLeagueId == 851,
                          onTap: () {
                            if (currentLeagueId != 851) {
                              cubit.switchDivision(851);
                            }
                          },
                        ),
                      ),
