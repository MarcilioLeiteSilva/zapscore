...
class _HomeTopScorersCardState extends State<HomeTopScorersCard> {
  ...
  int _selectedLeagueId = AppConfig.cariocaSerieAId;
  final Map<int, List<Scorer>> _scorersCache = {};
  final Map<int, bool> _loadingMap = {};

  final List<Map<String, dynamic>> _leagues = [
    {'id': AppConfig.cariocaSerieAId, 'name': 'Série A'},
    {'id': AppConfig.cariocaSerieA2Id, 'name': 'Série A2'},
  ];

  @override
  void initState() {
    super.initState();
    _fetchScorers(AppConfig.cariocaSerieAId);
  }
