...
class LeagueCubit extends Cubit<LeagueState> {
  ...
  Future<void> fetchLeagueData(int leagueId, {String? initialPhaseId}) async {
    ...
    try {
      ...
      String compName = leagueId == 851 ? 'Campeonato Carioca - Série A2' : 'Campeonato Carioca - Série A1';
      ...
      final defaultPhaseId = initialPhaseId ??
          (competition.phases.isNotEmpty ? competition.phases.first.id : 'taca_guanabara');
