...
class StandingsEngine {
  ...
  /// Separa a classificação da Taça Guanabara em Grupo A e Grupo B conforme regulamento oficial de 2026:
  /// Grupo A: Fluminense, Vasco, Volta Redonda, Sampaio Corrêa, Portuguesa, Bangu.
  /// Grupo B: Flamengo, Botafogo, Madureira, Maricá, Boavista, Nova Iguaçu.
  static Map<String, List<Standing>> splitCariocaA1Groups(List<Standing> rawStandings) {
