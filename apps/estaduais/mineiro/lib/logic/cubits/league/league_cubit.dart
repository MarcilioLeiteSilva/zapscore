...
class LeagueCubit extends Cubit<LeagueState> {
  ...
  Future<void> fetchLeagueData(int leagueId, {String? initialPhaseId}) async {
    ...
    try {
      ...
      String compName = leagueId == 619 ? 'Campeonato Mineiro - Módulo 2' : 'Campeonato Mineiro - Módulo 1';
      ...
      final defaultPhaseId = initialPhaseId ??
          (competition.phases.isNotEmpty ? competition.phases.first.id : 'primeira_fase_modulo_1');
