...
class _HomeTopScorersCardState extends State<HomeTopScorersCard> {
  ...
  int _selectedLeagueId = AppConfig.mineiroModulo1Id;
  final Map<int, List<Scorer>> _scorersCache = {};
  final Map<int, bool> _loadingMap = {};

  final List<Map<String, dynamic>> _leagues = [
    {'id': AppConfig.mineiroModulo1Id, 'name': 'Módulo 1'},
    {'id': AppConfig.mineiroModulo2Id, 'name': 'Módulo 2'},
  ];

  @override
  void initState() {
    super.initState();
    _fetchScorers(AppConfig.mineiroModulo1Id);
  }
