      ...
      child: BlocConsumer<LeagueCubit, LeagueState>(
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            ...
            body: Column(
              children: [
                // 1. Seletor de Divisão: [Módulo I] [Módulo II]
                Container(
                    ...
                    children: [
                      Expanded(
                        child: _DivisionButton(
                          title: 'Módulo I',
                          isSelected: currentLeagueId == 629 || currentLeagueId != 619,
                          onTap: () {
                            if (currentLeagueId != 629) {
                              cubit.switchDivision(629);
                            }
                          },
                        ),
                      ),
                      ...
                      Expanded(
                        child: _DivisionButton(
                          title: 'Módulo II',
                          isSelected: currentLeagueId == 619,
                          onTap: () {
                            if (currentLeagueId != 619) {
                              cubit.switchDivision(619);
                            }
                          },
                        ),
                      ),
