  ...
  Future<void> _loadLeagues() async {
    try {
      ...
      final filtered = list.where((league) {
        ...
        return AppConfig.supportedLeagueIds.contains(extId) || name.contains('mineiro');
      }).toList();

      bool hasMineiro = filtered.any((l) => AppConfig.supportedLeagueIds.contains(l.externalId) || l.name.toLowerCase().contains('mineiro'));

      if (!hasMineiro) {
        filtered.insert(0, League(id: '629', externalId: 629, name: 'Mineiro Módulo 1', country: 'Brazil'));
        filtered.add(League(id: '619', externalId: 619, name: 'Mineiro Módulo 2', country: 'Brazil'));
      }
      ...
      setState(() {
        _leagues = [
          League(id: '629', externalId: 629, name: 'Mineiro Módulo 1', country: 'Brazil'),
          League(id: '619', externalId: 619, name: 'Mineiro Módulo 2', country: 'Brazil'),
        ];
      });
    }
  }
