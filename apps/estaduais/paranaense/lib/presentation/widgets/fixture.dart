...
class _HomeTopScorersCardState extends State<HomeTopScorersCard> {
  ...
  int _selectedLeagueId = AppConfig.paranaenseSerieAId;
  final Map<int, List<Scorer>> _scorersCache = {};
  final Map<int, bool> _loadingMap = {};

  final List<Map<String, dynamic>> _leagues = [
    {'id': AppConfig.paranaenseSerieAId, 'name': 'Série A'},
    {'id': AppConfig.paranaenseSerieBId, 'name': 'Série B'},
  ];

  @override
  void initState() {
    super.initState();
    _fetchScorers(AppConfig.paranaenseSerieAId);
  }
