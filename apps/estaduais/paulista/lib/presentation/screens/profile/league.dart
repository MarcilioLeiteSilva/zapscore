                    ...
                    children: [
                      Expanded(
                        child: _DivisionButton(
                          title: 'Série A1',
                          isSelected: currentLeagueId == 475 || currentLeagueId != 476,
                          onTap: () {
                            if (currentLeagueId != 475) {
                              cubit.switchDivision(475);
                            }
                          },
                        ),
                      ),
                      ...
                      Expanded(
                        child: _DivisionButton(
                          title: 'Série A2',
                          isSelected: currentLeagueId == 476,
                          onTap: () {
                            if (currentLeagueId != 476) {
                              cubit.switchDivision(476);
                            }
                          },
                        ),
                      ),
