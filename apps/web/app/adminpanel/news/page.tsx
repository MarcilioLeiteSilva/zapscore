        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-slate-800">
              {loading ? (
                <tr><td colSpan={2} className="p-20 text-center text-slate-500"><Loader2 className="animate-spin mx-auto mb-4" size={32} /> Carregando base de dados...</td></tr>
              ) : news.map((item: any) => (
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-6">
              ...
              <div className="flex justify-end space-x-4 pt-4">
                ...
                <button type="submit" disabled={submitting} className="bg-orange-600 px-10 py-4 rounded-2xl font-black text-white hover:scale-105 transition-all shadow-xl disabled:opacity-50">
                  {submitting ? "ENVIANDO..." : "SALVAR NOTÍCIA"}
                </button>
              </div>
            </form>
          </div>
