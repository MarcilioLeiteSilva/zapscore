    ...
    return BlocProvider(
      ...
      child: BlocConsumer<LeagueCubit, LeagueState>(
        ...
        builder: (context, state) {
          ...
          final selectedPhaseId = state is LeagueLoaded ? state.selectedPhaseId : 'taca_guanabara';

          return Scaffold(
            appBar: AppBar(
              title: Text(
                currentLeagueId == AppConfig.brasileiraoSerieBId
                    ...
                    children: [
                      Expanded(
                        child: _DivisionButton(
                          title: 'Série A',
                          isSelected: currentLeagueId == AppConfig.brasileiraoSerieAId || currentLeagueId != AppConfig.brasileiraoSerieBId,
                          onTap: () {
                            if (currentLeagueId != AppConfig.brasileiraoSerieAId) {
                              cubit.switchDivision(AppConfig.brasileiraoSerieAId);
                            }
                          },
                        ),
                      ),
                      ...
                      Expanded(
                        child: _DivisionButton(
                          title: 'Série B',
                          isSelected: currentLeagueId == AppConfig.brasileiraoSerieBId,
                          onTap: () {
                            if (currentLeagueId != AppConfig.brasileiraoSerieBId) {
                              cubit.switchDivision(AppConfig.brasileiraoSerieBId);
                            }
                          },
                        ),
                      ),
