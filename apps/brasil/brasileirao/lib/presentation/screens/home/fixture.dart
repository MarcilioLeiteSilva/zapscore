              ...
              return [
                ...
                const SliverToBoxAdapter(
                  child: Column(
                    ...
                    children: [
                      Gap(12),
                      FavoriteTeamHomeCard(),
                      Gap(12),
                      CardCalendarHome(),
                      Gap(12),
                      HomeAiPerformanceBanner(),
                      Gap(12),
                    ],
                  ),
                ),
                ...
                builder: (context, settingState) {
                  ...
                  return Builder(
                    builder: (context) {
                      ...
                      if (state is HomeLoaded) {
                        final List<HomeCompetition> displayCompetitions = state.competitions.isNotEmpty
                            ? state.competitions
                            : [
                                HomeCompetition(
                                  league: League(
                        ...
                        return ListView.separated(
                          ...
                          itemBuilder: (_, i) {
                            ...
                            if (i == displayCompetitions.length + 2) {
                              return const AppNativeAdWidget();
                            }
                            return const HomeVideoCarouselSection();
                          },
                          separatorBuilder: (_, i) => const Gap(12),
                          itemCount: displayCompetitions.length + 4,
                        );
                      }
                      return const SizedBox();
                    },
    ...
    return Padding(
      ...
      child: ClipRRect(
        ...
        child: SfDateRangePicker(
          ...
          selectionColor: const Color(0xFF22C55E), // Verde Claro no círculo
          todayHighlightColor: const Color(0xFF4ADE80), // Verde Claro no dia atual
          allowViewNavigation: true,
          enableMultiView: false,
          headerHeight: 60,
          headerStyle: DateRangePickerHeaderStyle(
            backgroundColor: AppColor.info,
            textStyle: context.textTheme.bodySmall?.copyWith(color: Colors.white, fontWeight: FontWeight.bold),
          ),
          ...
          monthCellStyle: DateRangePickerMonthCellStyle(
            ...
            todayTextStyle: const TextStyle(color: Color(0xFF4ADE80), fontWeight: FontWeight.bold),
          ),
