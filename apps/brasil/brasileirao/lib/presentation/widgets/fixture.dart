...
class _HomeTopScorersCardState extends State<HomeTopScorersCard> {
  ...
  int _selectedLeagueId = AppConfig.brasileiraoSerieAId;
  final Map<int, List<Scorer>> _scorersCache = {};
  final Map<int, bool> _loadingMap = {};

  final List<Map<String, dynamic>> _leagues = [
    {'id': AppConfig.brasileiraoSerieAId, 'name': 'Série A'},
    {'id': AppConfig.brasileiraoSerieBId, 'name': 'Série B'},
  ];

  @override
  void initState() {
    super.initState();
    _fetchScorers(AppConfig.brasileiraoSerieAId);
  }
