...
class PushNotificationService {
  ...
  static const AndroidNotificationChannel _channel = AndroidNotificationChannel(
    'brasileirao_live_channel',
    'Alertas Brasileirão',
    description: 'Notificações ao vivo de gols, início e fim de partidas do Campeonato Brasileiro.',
    ...
    try {
      ...
      if (queryRes.statusCode == 200) {
        ...
        if (items != null && items.isNotEmpty) {
          ...
          debugPrint('PocketBase Brasil: Aparelho atualizado com sucesso ($existingId)');
          ...
          if (items.length > 1) {
            for (int i = 1; i < items.length; i++) {
              ...
              try {
                ...
                debugPrint('PocketBase Brasil: Registro duplicado removido ($dupId)');
              } catch (_) {}
            }
          }
          _isSyncing = false;
      ...
      if (createRes.statusCode == 200 || createRes.statusCode == 201) {
        debugPrint('PocketBase Brasil: Novo aparelho registrado com sucesso');
      } else {
