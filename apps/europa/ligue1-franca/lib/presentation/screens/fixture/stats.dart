                ...
                child: Column(
                  children: [
                    for (var i = 0; i < statTypes.length; i++) ...[
                      ...
                      if (i < statTypes.length - 1) const Gap(12),
                    ],
                  ],
                ),
              ),
    ...
    return Column(
      children: [
        Row(
          ...
          children: [
            Text(homeStat, style: GoogleFonts.urbanist(textStyle: context.textTheme.bodySmall!.copyWith(fontSize: 15))),
            Text(getStatTranslation(type, context), style: GoogleFonts.urbanist(textStyle: context.textTheme.bodySmall!.copyWith(fontSize: 15))),
            Text(awayStat, style: GoogleFonts.urbanist(textStyle: context.textTheme.bodySmall!.copyWith(fontSize: 15))),
          ],
        ),
        const Gap(10),
