    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<NewsCubit>(
          create: (BuildContext context) => NewsCubit(apiClient)..fetchNews(leagueId: AppConfig.leagueId),
        ),
        BlocProvider<VideoCubit>(
          create: (BuildContext context) => VideoCubit(apiClient)..fetchVideos(leagueId: AppConfig.leagueId),
        ),
      ],
