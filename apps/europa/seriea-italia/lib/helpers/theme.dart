...
abstract class AppTheme {
  static ThemeData getTheme(BuildContext context, String themeType) {
    ...
    final isLight = isWhite || isDefault;
    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        backgroundColor: appBarBg.withOpacity(0.65),
        elevation: 0,
        ...
        titleTextStyle: GoogleFonts.urbanist(
          textStyle: TextStyle(
            color: isDefault ? Colors.black : textColor,
            fontWeight: FontWeight.bold,
            fontSize: 22,
          ),
        ),
        iconTheme: IconThemeData(color: isDefault ? Colors.black : textColor),
        actionsIconTheme: IconThemeData(color: isDefault ? Colors.black : textColor),
      ),
      ...
      iconTheme: IconThemeData(color: isDefault ? AppColor.primary : textColor),
    );
  }
}
