...
class PushNotificationService {
  ...
  static const AndroidNotificationChannel _channel = AndroidNotificationChannel(
    'seriea-italia_live_channel',
    'Alertas Serie A',
    description: 'Notificações ao vivo de gols, início e fim de partidas da Serie A.',
    ...
    try {
      ...
      if (queryRes.statusCode == 200) {
        ...
        if (items != null && items.isNotEmpty) {
          ...
          debugPrint('PocketBase Europa: Aparelho atualizado com sucesso ($existingId)');
          ...
          if (items.length > 1) {
            for (int i = 1; i < items.length; i++) {
              ...
              try {
                ...
                debugPrint('PocketBase Europa: Registro duplicado removido ($dupId)');
              } catch (_) {}
            }
          }
          _isSyncing = false;
