...
abstract class AppColor {
  // --- Tema Padrão (Fundo #FCBF04, Cards Grafite Profundo #1E1E24 e Ícones #E30613) ---
  static const Color primary = Color(0xFFE30613);          // Ícones Vermelhos La Liga #E30613
  static const Color accent = Color(0xFFE30613);           // Vermelho Destaque #E30613
  static const Color background = Color(0xFFFC9604);       // Fundo #FC9604
  ...
  static const Color darkGreen = Color(0xFFD78511);        // Ícones nos Cards #D78511
  static const Color drawerBackground = Color(0xFFD78511); // Fundo #D78511 Drawer
  static const Color drawerHeader = Color(0xFF454444);     // Cards Header #454444
  static const Color appBarBackground = Color(0xFFC98320);  // Fundo #C98320 AppBar

  // --- Tema Escuro (Monochrome / Slate Night) ---
  static const Color darkPrimary = Color(0xFFFF4B5C);      // Vermelho Acento La Liga
  ...
  static const Color lightPrimary = Color(0xFFE30613);     // Vermelho La Liga Destaque
