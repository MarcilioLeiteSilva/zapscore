    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Legenda Oficial UEFA Champions League
          const Gap(14),
          Divider(color: Theme.of(context).dividerColor.withOpacity(0.15)),
          const Gap(8),
          _buildLegendItem(
            color: const Color(0xFF10B981),
            text: '1º ao 8º: Classificados diretamente para as Oitavas',
          ),
          const Gap(4),
          _buildLegendItem(
            color: const Color(0xFF38BDF8),
            text: '9º ao 24º: Play-offs da Fase Eliminatória',
          ),
          const Gap(4),
          _buildLegendItem(
            color: const Color(0xFFEF4444),
            text: '25º ao 36º: Eliminados',
          ),
        ],
      ),
    );
