...
abstract class AppColor {
  // --- Tema Padrão (Fundo Champions League #284F8E e Cards em tom mais escuro #1B3765) ---
  static const Color primary = Color(0xFFFFFFFF);          // Branco para ícones/destaques
  static const Color accent = Color(0xFFFBBF24);           // Amarelo vibrante e harmonioso
  static const Color background = Color(0xFF284F8E);       // Fundo #284F8E
  static const Color card = Color(0xFF1B3765);             // Cards em tom mais escuro #1B3765
  static const Color text = Color(0xFFFFFFFF);             // Fonte Branca para Contraste
  static const Color darkGreen = Color(0xFF284F8E);        // Destaque azul champions
  static const Color drawerBackground = Color(0xFF1B3765); // Fundo Drawer
  static const Color drawerHeader = Color(0xFF152A4E);     // Header Drawer
  static const Color appBarBackground = Color(0xFF1B3765); // Fundo AppBar
  ...
  static const Color lightPrimary = Color(0xFF284F8E);     // Azul Destaque
