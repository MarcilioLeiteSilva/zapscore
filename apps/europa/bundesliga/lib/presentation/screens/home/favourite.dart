                                ...
                                return Ink(
                                  ...
                                  child: ListTile(
                                    leading: CachedNetworkImage(imageUrl: proxyImage(league.logo ?? ''),
                                     ...
                                     title: Text(league.name, style: GoogleFonts.urbanist(color: Colors.white, fontWeight: FontWeight.w600)),
                                     subtitle: Text(league.type ?? '', style: GoogleFonts.urbanist(color: Colors.white70)),
                                ...
                                return Ink(
                                  ...
                                  child: ListTile(
                                    leading: CachedNetworkImage(imageUrl: proxyImage(team.logo ?? ''),
                                     ...
                                     title: Text(team.name, style: GoogleFonts.urbanist(color: Colors.white, fontWeight: FontWeight.w600)),
                                     subtitle: Text(team.country ?? '', style: GoogleFonts.urbanist(color: Colors.white70)),
                                    trailing: const Icon(Icons.chevron_right),
                                    onTap: () {
