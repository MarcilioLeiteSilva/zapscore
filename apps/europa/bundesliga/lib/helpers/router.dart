...
const String screenTopScorers = 'top-scorers';
...
const String screenPrivacyPolicy = "privacy-policy-sett";
const String screenLgpd = "lgpd-sett";
  ...
  static final router = GoRouter(
    routes: [
      ...
      GoRoute(
        path: '/$screenLgpd',
        name: screenLgpd,
        builder: (context, state) => const LgpdScreen(),
      ),
      GoRoute(
        path: '/$screenEditInfo',
        name: screenEditInfo,
      ...
      GoRoute(
        path: '/$screenTopScorers',
        name: screenTopScorers,
